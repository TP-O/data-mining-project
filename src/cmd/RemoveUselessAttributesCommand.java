...
public class RemoveUselessAttributesCommand implements Command {
	public final static String REMOVED_REDUNDANCY_CSV_DATASET = "data/removed_redundancy_mxmh_survey_results.csv";

	public final static String REMOVED_REDUNDANCY_ARFF_DATASET = "data/removed_redundancy_mxmh_survey_results.arff";
	...
	public void exec() {
		...
		try {
			...
			remove.setOptions(new String[] { "-R", "1,33" });
