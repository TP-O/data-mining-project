...
public class CleanDataCommand implements Command {
	public final static String CLEAN_CSV_DATASET = "data/clean_mxmh_survey_results.csv";

	public final static String CLEAN_ARFF_DATASET = "data/clean_mxmh_survey_results.arff";
	...
	public void exec() {
		...
		try {
			...
			remove.setOptions(new String[] { "-R", "32,33" });
